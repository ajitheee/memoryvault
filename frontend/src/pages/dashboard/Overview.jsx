  ...
  return (
    <div>
        ...
        actions={
          <>
            <button
              ...
              className="inline-flex items-center gap-2 border border-[#1F2A33] px-3 py-2 text-sm text-neutral-300 hover:text-white hover:border-[#22D3EE]/50 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              onClick={doExport}
              className="inline-flex items-center gap-2 border border-[#1F2A33] px-3 py-2 text-sm text-neutral-300 hover:text-white hover:border-[#22D3EE]/50 transition-colors"
            >
      ...
      <div className="p-8 space-y-8">
        {/* Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#1F2A33] border border-[#1F2A33]" data-testid="stats-grid">
          {STATS.map((s) => (
            <div key={s.key} className="bg-[#0A0F14] p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#1F2A33] border border-[#1F2A33]">
          <div className="bg-[#0A0F14] p-6">
          ...
          <div className="bg-[#0A0F14] p-6 col-span-2">
            ...
            <div className="flex flex-wrap gap-2">
              {Object.entries(stats?.by_type || {}).map(([t, c]) => (
                <span key={t} className="font-mono text-xs border border-[#1F2A33] px-2 py-1 text-neutral-300">
        ...
        <div className="border border-[#1F2A33]">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[#1F2A33]">
          ...
          {pending.length === 0 ? (
            ...
            <div className="divide-y divide-[#1F2A33]">
